...
rm(list=ls()) 
wd <- "/home/marta/Dropbox/Sebastian/alscellatlas_data"
...
generateGraphFile <- function(gen){
  #print(gen)
    ...
    grid.arrange(p1, p2,p2b, p3, layout_matrix = lay, widths= c(4,4,0,10,6,1,7), heights= c(8,1))
    dev.off()
}

wdForGraphs <- "/home/marta/Github/ALSCellAtlasData/exGraphs"
setwd(wdForGraphs)
